...
var _Assetsf0592ff97a107ea2b646fc94774b000e18577760 = ""
var _Assetsae1cddc9690234d137f0342dea38c3c467339548 = "<html>\r\n<head>\r\n  <title>test page</title>\r\n</head> \r\n\r\n<body>\r\n   <h2>Hello there</h2>\r\n</body>\r\n\r\n</html>"

// Assets returns go-assets FileSystem
var Assets = assets.NewFileSystem(map[string][]string{"/views/another": []string{"test.html"}, "/": []string{"views"}, "/views": []string{"home.html", "views.go"}}, map[string]*assets.File{
	"/views": &assets.File{
		Path:     "/views",
		FileMode: 0x800001ff,
		Mtime:    time.Unix(1535103620, 1535103620713605100),
		Data:     nil,
	}, "/views/another": &assets.File{
		Path:     "/views/another",
		FileMode: 0x800001ff,
		Mtime:    time.Unix(1535103620, 1535103620713605100),
		Data:     nil,
	}, "/views/another/test.html": &assets.File{
		Path:     "/views/another/test.html",
		FileMode: 0x1b6,
		Mtime:    time.Unix(1535103620, 1535103620721999800),
		Data:     []byte(_Assetsae1cddc9690234d137f0342dea38c3c467339548),
	...
	}, "/views/views.go": &assets.File{
		Path:     "/views/views.go",
		FileMode: 0x1b6,
		Mtime:    time.Unix(1535103757, 1535103757572344100),
		Data:     []byte(_Assetsf0592ff97a107ea2b646fc94774b000e18577760),
	}, "/": &assets.File{
		Path:     "/",
		FileMode: 0x800001ff,
		Mtime:    time.Unix(1535101457, 1535101457448397100),
		Data:     nil,
	}}, "")
